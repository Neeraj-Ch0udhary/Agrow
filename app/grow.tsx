...
const TASKS = [
  { day: 'Day 1–3', task: 'Prepare your growing space', desc: 'Clean the area, gather all materials and equipment needed.' },
  { day: 'Day 4–7', task: 'Plant your crop', desc: 'Sow seeds or set up spawn. Follow your crop guide carefully.' },
  { day: 'Day 8–14', task: 'Daily watering & monitoring', desc: 'Water once or twice daily. Check for pests or unusual changes.' },
  { day: 'Day 15–30', task: 'Growth phase check', desc: 'Your crop is growing! Maintain humidity and temperature.' },
  { day: 'Day 31–45', task: 'Pre-harvest preparation', desc: 'Start finding buyers. Contact local restaurants and markets.' },
  { day: 'Day 45+', task: 'Harvest time! 🎉', desc: 'Harvest carefully and package for delivery to buyers.' },
];
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.headerSection}>
          ...
          <Text style={styles.headerSub}>{t('grow.subtitle')}</Text>
        </View>
        <View style={styles.tipCard}>
          <Text style={styles.tipTitle}>{t('grow.proTip')}</Text>
          <Text style={styles.tipText}>{t('grow.proTipText')}</Text>
        </View>
        <Text style={styles.sectionLabel}>{t('grow.timeline')}</Text>
        {TASKS.map((task, i) => (
